...
def main():
    ...
    try:
        ...
        # Test READ function with specific variable ID (required)
        test_variable_id = os.getenv("TFE_VARIABLE_ID")
        print("\n4. Testing READ operation with specific variable ID:")
        print("-" * 50)
        
        if not test_variable_id:
            print("ERROR: TFE_VARIABLE_ID environment variable is required")
            print("Please set TFE_VARIABLE_ID to a valid variable ID in your workspace")
            sys.exit(1)
        ...
        # Test UPDATE function with specific variable ID (required)
        ...
        # Test DELETE function with specific variable ID (required)
