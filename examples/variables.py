...
def main():
    ...
    try:
        ...
        # Test READ function with specific variable ID (if provided)
        ...
        # Test UPDATE function with specific variable ID (if provided)
        test_variable_id = os.getenv("TFE_VARIABLE_ID")
        if test_variable_id:
        ...
        # Test DELETE function with specific variable ID (if provided)
        test_variable_id = os.getenv("TFE_VARIABLE_ID")
        if test_variable_id:
